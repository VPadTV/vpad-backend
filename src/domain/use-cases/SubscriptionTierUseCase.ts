...
export class SubscriptionTierUseCase {
    constructor(private subscriptionTierRepository: ISubscriptionTierRepository) {}
    async createSubscriptionTier(request: any): Promise<any> {
