...
export class UserUseCase {
    ...
    async registerUser(request): Promise<unknown> {
    ...
    async loginUser(request): Promise<unknown> {
    ...
    async manageBan(request): Promise<unknown> {
    ...
    async getUsers(request): Promise<unknown> {
    ...
    async deleteUser(request): Promise<unknown> {
