...
export class PostUseCase {
    ...
    async createPost(request): Promise<unknown> {
    ...
    async getPostById(request): Promise<unknown> {
    ...
    async updatePost(request): Promise<unknown> {
    ...
    async deletePost(request): Promise<unknown> {
    ...
    async postStreamKey(request): Promise<unknown> {
        if (request.key) {
